...
abstract class TweetSet {
  ...
  def union(that: TweetSet): TweetSet = {
    if (that.isEmpty) this else incl(that.head).union(that.tail)
  }
...
class Empty extends TweetSet {
  ...
  override def head: Nothing = throw new NoSuchElementException("You have reached EMpty.Head")

  override def tail: Nothing = throw new NoSuchElementException("You have reached EMpty.Tail")
